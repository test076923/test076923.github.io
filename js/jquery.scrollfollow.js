...
*/ (function($) {
    ...
    $.scrollFollow = function(box, options) {
        ...
        function ani() {
            ...
            var viewportHeight = parseInt($(window)
                .height());
            var pageScroll = parseInt($(document)
                .scrollTop());
            var parentTop = parseInt($("body")
                .offset()
                .top);
            var parentHeight = parseInt($("body")
                .height());
            ...
            if (isActive) {
                ...
                if ((new Date()
                    .getTime() - box.lastScroll) >= (options.delay - 20)) {
                    box.animate({
                        top: aniTop
        ...
        box.initialOffsetTop = parseInt(box.offset()
            .top);
        box.initialTop = parseInt(box.css('top')) || 0;

        // Hack to fix different treatment of boxes positioned 'absolute' and 'relative'
        if (box.css('position') == 'relative') {
            box.paddingAdjustment = parseInt($("body")
                .css('paddingTop')) + parseInt($("body")
                .css('paddingBottom'));
        } else {
